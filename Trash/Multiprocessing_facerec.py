...
def capture(read_frame_list, Global, worker_num):
    ...
    #video_capture = cv2.VideoCapture('Prueba_Tello.mp4')
    video_capture = tello_capture.Video_capture_Tello(sock, tello_address, mypc_address)
    ...
    while not Global.is_exit:
        while Global.write_num != last_num:
            ...
            if int(time.time())%2==0:
                print(sock.sendto('Time'.encode(' utf-8 '), tello_address))
